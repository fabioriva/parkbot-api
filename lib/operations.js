...
export const byCard = async function byCard (start, end, history) {
  const pipeline = [
    {
      $match: {
...
export const byDevice = async function byDevice (start, end, devices, history) {
...
export const byRange = async function byRange (start, end, history) {
...
export const daily = async function daily (date, history) {
...
export const weekly = async function weekly (date, history) {
...
export const monthly = async function monthly (date, history) {
...
export const yearly = async function yearly (date, history) {
