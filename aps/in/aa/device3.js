...
const lamps = [
  inputs.find(b => b.addr === 'E310.4'),
  outputs.find(b => b.addr === 'A300.5'),
  outputs.find(b => b.addr === 'A300.4')
]

const EN1 = inputs.find(b => b.addr === 'E300.5')
 ...
 * Hoisting
 */
const FSBK = inputs.find(b => b.addr === 'E300.3')
const ASBK = inputs.find(b => b.addr === 'E300.2')
const RTA = inputs.find(b => b.addr === 'E300.1')
const SBK1 = outputs.find(b => b.addr === 'A300.0')
const SBK2 = outputs.find(b => b.addr === 'A300.1')
...
const ASH = inputs.find(b => b.addr === 'E313.6')
