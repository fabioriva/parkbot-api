export const APS = 'boi'
export const PORT = 49033
export const HOST =
  process.env.NODE_ENV !== 'production'
    ? process.env.DEVELOPMENT_SERVER
    : process.env.PRODUCTION_SERVER
export const HTTP = 9028
export const PLC = {
  ip: '192.168.73.2',
  rack: 0,
  slot: 1,
...
export const DB_DATA_INIT_QUEUE = 224
export const DB_DATA_INIT_AB = 244
export const DB_DATA_INIT_EB = 278
export const DB_DATA_INIT_MB = 324
