...
const inputs2 = generateBits('E', 10, 11, str.inputs2)
const inputs3 = generateBits('E', 14, 21, str.inputs3)
...
const outputs2 = generateBits('A', 10, 11, str.outputs2)
const outputs3 = generateBits('A', 14, 19, str.outputs3)
