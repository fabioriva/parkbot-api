...
import device12 from './device12.js'
...
const al07 = new Alarms(generateAlarms(1, 64, str.alarms2), 7) // SH2
const al08 = new Alarms(generateAlarms(1, 64, str.alarms2), 8) // SH3
const al09 = new Alarms(generateAlarms(1, 64, str.alarms2), 9) // SH4
const al10 = new Alarms(generateAlarms(1, 64, str.alarms2), 10) // SH5
const al11 = new Alarms(generateAlarms(1, 64, str.alarms2), 11) // SH6
const al12 = new Alarms(generateAlarms(1, 64, str.alarms2), 12) // SH7
