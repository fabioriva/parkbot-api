...
const al07 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH2
const al08 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH3
const al09 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH4
const al10 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH5
const al11 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH6
const al12 = new Alarms(generateAlarms(1, 64, str.alarms2), 1) // SH7
