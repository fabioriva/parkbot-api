export const APS = 'kg'
export const PORT = 49029
export const HOST =
  process.env.NODE_ENV !== 'production'
    ? process.env.DEVELOPMENT_SERVER
    : process.env.PRODUCTION_SERVER
export const HTTP = 9024
export const PLC = {
  ip: '192.168.70.2',
  rack: 0,
  slot: 1,
...
const DB_DATA = 505
const DB_DATA_LEN = 204
export const DB_DATA_INIT_DEVICE = 32
export const DB_DATA_INIT_DRIVE = 64
export const DB_DATA_INIT_POS = 94
export const DB_DATA_INIT_QUEUE = 114
export const DB_DATA_INIT_AB = 134
export const DB_DATA_INIT_EB = 158
