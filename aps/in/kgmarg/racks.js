...
const pn01 = new Pn('CPU', 1, merkers.find(b => b.addr === 'M4.0'), 'IM 155-6 PN ST', { key: 'im', query: {} })
pn01.rack = rack1
PN.push(pn01)
...
const rack5 = {
  ...
  cards: [
    ...
    new S7_521_1BL00_0AB0(2, eb.slice(26, 30)),
    new S7_521_1BH00_0AB0(3, eb.slice(30, 32)),
...
const rack8 = {
  ...
  cards: [
    ...
    new S7_521_1BL00_0AB0(2, eb.slice(44, 48)),
    new S7_521_1BH00_0AB0(3, eb.slice(48, 50)),
    new S7_522_1BL01_0AB0(4, ab.slice(28, 32)),
    new S7_522_1BH01_0AB0(5, ab.slice(32, 34))
  ]
}
// KKP3
const rack9 = {
  nr: 9,
  cards: [
    new S7_131_6BH01_0BA0(1, eb.slice(50, 52)),
    new S7_132_6BH01_0BA0(2, ab.slice(34, 36))
  ]
}
// SH3
const rack10 = {
  ...
  cards: [
    ...
    new S7_132_6BH01_0BA0(4, ab.slice(36, 38)),
    new S7_132_6BH01_0BA0(5, ab.slice(38, 40))
  ]
}
const pn08 = new Pn('LS3', 5, merkers.find(b => b.addr === 'M4.7'), 'IM 155-6 PN ST', { key: 'im', query: {} })
pn08.rack = rack8
PN.push(pn08)
const pn09 = new Pn('KKP3', 6, merkers.find(b => b.addr === 'M5.0'), 'IM 155-6 PN ST', { key: 'im', query: {} })
pn09.rack = rack9
PN.push(pn09)
const pn10 = new Pn('SH3', 7, merkers.find(b => b.addr === 'M5.1'), 'IM 155-6 PN ST', { key: 'im', query: {} })
pn10.rack = rack10
PN.push(pn10)
