...
import { S7_131_6BH01_0BA0, S7_132_6BH01_0BA0 } from '../../../models/Modules.js'
...
const pn04 = new Pn('LS2', 4, merkers.find(b => b.addr === 'M4.3'), 'IM 155-6 PN ST', { key: 'im', query: {} })
const pn05 = new Pn('KKP2', 5, merkers.find(b => b.addr === 'M4.4'), 'IM 155-6 PN ST', { key: 'im', query: {} })
const pn06 = new Pn('SH2', 6, merkers.find(b => b.addr === 'M4.5'), 'IM 155-6 PN ST', { key: 'im', query: {} })
...
export default [pn00, pn01, pn02, pn03, pn04, pn05, pn06]
