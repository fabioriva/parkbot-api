 ...
 */
const A0 = new ActionPP('action-pp', merkers.find(b => b.addr === 'M6.3'), 4, 1, 7, [
...
const A1 = new ActionPP('action-pp-reset', merkers.find(b => b.addr === 'M6.7'), 1, 1, 7, [
...
const device = new Device(4, 'VT4', [A0, A1], lamps, motors, views)
