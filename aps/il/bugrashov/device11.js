 ...
 */
const A0 = new ActionPP('action-pp', merkers.find(b => b.addr === 'M7.6'), 11, 1, def.STALLS_PP, [
  { id: 1, key: 'E', value: '0', tooltip: 'send SH to stall' },
  { id: 2, key: 'D', value: '0', tooltip: 'send SH to stall + Silomat cycle' }
])

const A1 = new ActionPP('action-pp-reset', merkers.find(b => b.addr === 'M2.6'), 11, 1, def.STALLS_PP, [
  { id: 1, key: 'A', value: '0', tooltip: 'reset PP' }
])

const EN1 = inputs.find(b => b.addr === 'E1603.0')
...
const device = new Device(11, 'SH7', [A0, A1], lamps, motors, views)
