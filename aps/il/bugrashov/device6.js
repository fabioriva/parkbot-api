 ...
 */
const A0 = new ActionPP('action-pp', merkers.find(b => b.addr === 'M7.1'), 6, 1, def.STALLS_PP, [
  { id: 1, key: 'E', value: '0', tooltip: 'send SH to stall' },
  { id: 2, key: 'D', value: '0', tooltip: 'send SH to stall + Silomat cycle' }
])

const A1 = new ActionPP('action-pp-reset', merkers.find(b => b.addr === 'M2.1'), 6, 1, def.STALLS_PP, [
