 ...
 */
const A0 = new ActionPP('action-pp', merkers.find(b => b.addr === 'M7.2'), 7, 1, def.STALLS_PP, [
  { id: 1, key: 'E', value: '0', tooltip: 'send SH to stall' },
  { id: 2, key: 'D', value: '0', tooltip: 'send SH to stall + Silomat cycle' }
])

const A1 = new ActionPP('action-pp-reset', merkers.find(b => b.addr === 'M2.2'), 7, 1, def.STALLS_PP, [
  { id: 1, key: 'A', value: '0', tooltip: 'reset PP' }
])

const EN1 = inputs.find(b => b.addr === 'E1203.0')
...
const device = new Device(7, 'SH3', [A0, A1], lamps, motors, views)
