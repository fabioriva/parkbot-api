 ...
 */
const A0 = new ActionPP('action-pp', merkers.find(b => b.addr === 'M6.2'), 3, 1, 7, [
...
const A1 = new ActionPP('action-pp-reset', merkers.find(b => b.addr === 'M6.6'), 1, 1, 7, [
...
const M8 = new Door(4, [EZE, EOE, FBE, APE], [SZE, SOE, SPE, KXPE])
...
const M9 = new Barrier(2, [EBZE, EBOE, FBBE, APBE], [SBZE, SBOE, SPBE])
...
const M10 = new Door(3, [EZA, EOA, FBA, APA], [SZA, SOA, SPA, KXPA])
...
const FLP2 = inputs.find(b => b.addr === 'E307.1')
const FLP3 = inputs.find(b => b.addr === 'E309.0')
const FPE = inputs.find(b => b.addr === 'E306.3')
const FRE1 = inputs.find(b => b.addr === 'E304.6')
const FRE2 = inputs.find(b => b.addr === 'E304.7')
...
const garage = new Garage(
  ...
  [M7, M8, M9, M10],
  [L1, L2, L3, L4, L5],
  [FRE1, FPE, FLA, FLP, FDL, FDR, FTA1, FTA2, FTA3, FRE1, FRE2, FLP2, FLP3]
)
const views = [main, garage]

const device = new Device(3, 'VT3', [A0, A1], lamps, motors, views)
