...
const FX = inputs.find(b => b.addr === 'E8.7')
...
const KX = outputs.find(b => b.addr === 'A7.3')
const SP = outputs.find(b => b.addr === 'A7.0')
const SZ = outputs.find(b => b.addr === 'A7.1')
const SO = outputs.find(b => b.addr === 'A7.2')
...
const FTA1 = inputs.find(b => b.addr === 'E4.6')
const FTA2 = inputs.find(b => b.addr === 'E4.7')
const FDL1 = inputs.find(b => b.addr === 'E4.6')
const FDR1 = inputs.find(b => b.addr === 'E4.7')
