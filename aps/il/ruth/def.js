export const APS = 'ruth'
export const PORT = 49050
// export const HOST =
//   process.env.NODE_ENV !== 'production'
//     ? process.env.DEVELOPMENT_SERVER
//     : process.env.PRODUCTION_SERVER
export const HTTP = 9047
export const PLC = {
  ip: '140.80.42.12',
  rack: 0,
  slot: 1,
