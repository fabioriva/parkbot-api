...
const RTA = inputs.find(b => b.addr === 'E203.6')
const ASBK = inputs.find(b => b.addr === 'E203.5')
const FSBK = inputs.find(b => b.addr === 'E203.4')
const SBK1 = outputs.find(b => b.addr === 'A204.7')
const SBK2 = outputs.find(b => b.addr === 'A205.7')
...
const AMM = inputs.find(b => b.addr === 'E209.0')
const EOM = inputs.find(b => b.addr === 'E204.0')
const EZM = inputs.find(b => b.addr === 'E204.1')
const SMA = outputs.find(b => b.addr === 'A205.0')
const SMB = outputs.find(b => b.addr === 'A205.1')
...
const SCA = outputs.find(b => b.addr === 'A205.4')
const SCB = outputs.find(b => b.addr === 'A205.5')
...
const SP = outputs.find(b => b.addr === 'A206.0')
...
const FLP1 = inputs.find(b => b.addr === 'E207.1')
...
const device = new Device(2, 'ELB', [], lamps, motors, views)
