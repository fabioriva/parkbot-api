export const APS = 'herzel'
export const PORT = 49034
export const HOST =
  process.env.NODE_ENV !== 'production'
    ? process.env.DEVELOPMENT_SERVER
    : process.env.PRODUCTION_SERVER
export const HTTP = 9031
export const PLC = {
  ip: '192.168.79.2',
  rack: 0,
  slot: 1,
...
export const DBS_ALARM = [534, 535, 531, 532, 533] // ELA/B, SH1/2/3

// const CARDS = 109
// const CARD_LEN = 10
export const CARDS = 109
export const CARD_LEN = 10

const DB_DATA = 505
const DB_DATA_LEN = 346
export const DB_DATA_INIT_DEVICE = 32
export const DB_DATA_INIT_DRIVE = 112
export const DB_DATA_INIT_POS = 192
export const DB_DATA_INIT_QUEUE = 244
export const DB_DATA_INIT_AB = 264
export const DB_DATA_INIT_EB = 296
export const DB_DATA_INIT_MB = 338
